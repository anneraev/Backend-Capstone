...
namespace backendcapstone.Migrations
{
    ...
    [Migration("20190731221333_SeedData")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackendClassLibrary.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "25542c3f-8203-4bbf-906e-985f854613ed",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEN0rNM/tB67dBePrsIFlHV9oILSy0/IvZ39ba6PnrFC5RqCKSBNGV41H6sY9ALT/cA==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8a5b6561-4f8a-4a9a-8a3b-ff3580e50d98",
            ...
            modelBuilder.Entity("BackendClassLibrary.Models.Engine", b =>
                {
            ...
            modelBuilder.Entity("BackendClassLibrary.Models.Plugin", b =>
                {
            ...
            modelBuilder.Entity("BackendClassLibrary.Models.PluginType", b =>
                {
                    b.Property<int>("PluginTypeId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BackendClassLibrary.Models.UserVersion", b =>
                {
            ...
            modelBuilder.Entity("BackendClassLibrary.Models.Version", b =>
                {
                    b.Property<int>("VersionId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BackendClassLibrary.Models.Plugin", b =>
                {
                    b.HasOne("BackendClassLibrary.Models.Engine", "Engine")
                        .WithMany()
                        .HasForeignKey("EngineId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("BackendClassLibrary.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("BackendClassLibrary.Models.UserVersion", b =>
                {
                    ...
                    b.HasOne("BackendClassLibrary.Models.Version", "Version")
                        .WithMany("UserVersions")
            ...
            modelBuilder.Entity("BackendClassLibrary.Models.Version", b =>
                {
                    b.HasOne("BackendClassLibrary.Models.Plugin", "Plugin")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BackendClassLibrary.Models.ApplicationUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
