    ...
    public partial class SeedData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "00000000-ffff-ffff-ffff-ffffffffffff", 0, null, "25542c3f-8203-4bbf-906e-985f854613ed", "admin@admin.com", true, null, true, false, null, "admin", "ADMIN@ADMIN.COM", "ADMIN@ADMIN.COM", "AQAAAAEAACcQAAAAEN0rNM/tB67dBePrsIFlHV9oILSy0/IvZ39ba6PnrFC5RqCKSBNGV41H6sY9ALT/cA==", null, false, "7f434309-a4d9-48e9-9ebb-8803db794577", false, "admin@admin.com", null },
                    { "10000000-ffff-ffff-ffff-ffffffffffff", 0, null, "8a5b6561-4f8a-4a9a-8a3b-ff3580e50d98", "notadmin@notadmin.com", true, null, false, false, null, "notadmin", "NOTADMIN@NOTADMIN.COM", "NOTADMIN@NOTADMIN.COM", null, null, false, "8f434309-a4d9-48e9-9ebb-8803db794577", false, "notadmin@notadmin.com", null }
                });
            ...
            migrationBuilder.InsertData(
                table: "Plugins",
                columns: new[] { "PluginId", "CommercialUse", "EngineId", "Free", "PluginTypeId", "Title", "UserId", "Webpage" },
                values: new object[,]
                {
                    { 1, 0, 1, false, 1, "YEP Battle System - CTB", "00000000-ffff-ffff-ffff-ffffffffffff", null },
                    { 2, 0, 1, false, 2, "Mog Status Menu", "10000000-ffff-ffff-ffff-ffffffffffff", null },
                    { 3, 0, 1, false, 2, "Mog Save Menu", "10000000-ffff-ffff-ffff-ffffffffffff", null },
                    { 4, 0, 1, false, 1, "Mog Area Target", "10000000-ffff-ffff-ffff-ffffffffffff", null },
                    { 5, 0, 2, false, 2, "Game Maker Start Menu", "00000000-ffff-ffff-ffff-ffffffffffff", null }
                });
            ...
            migrationBuilder.InsertData(
                table: "UserVersions",
                columns: new[] { "UserVersionId", "UserId", "VersionId" },
                values: new object[] { 2, "00000000-ffff-ffff-ffff-ffffffffffff", 2 });

            migrationBuilder.InsertData(
                table: "UserVersions",
                columns: new[] { "UserVersionId", "UserId", "VersionId" },
                values: new object[] { 3, "10000000-ffff-ffff-ffff-ffffffffffff", 4 });
